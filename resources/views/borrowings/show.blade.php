...
<div class="max-w-4xl mx-auto">
    <div class="mb-8 flex items-center justify-between">
        ...
        <div class="flex gap-2">
            <a href="{{ route('borrowings.index') }}" class="p-2 bg-white text-slate-500 hover:text-indigo-600 rounded-lg border border-slate-200 shadow-sm hover:border-indigo-200 transition-colors" title="Kembali">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                </svg>
            </a>
            <a href="{{ route('borrowings.edit', $borrowing->id) }}" class="inline-flex items-center px-4 py-2 bg-indigo-50 border border-indigo-100 rounded-lg text-sm font-semibold text-indigo-700 hover:bg-indigo-100 transition-colors">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-8">
        ...
        <div class="bg-indigo-50 px-8 py-4 border-b border-indigo-100 flex items-center gap-3">
            ...
            <div>
                <h3 class="font-bold text-indigo-800">Sedang Dipinjam</h3>
                <p class="text-sm text-indigo-600">Harap kembalikan buku sebelum jatuh tempo.</p>
            </div>
        </div>
        @elseif($borrowing->status === 'Terlambat')
        <div class="bg-rose-50 px-8 py-4 border-b border-rose-100 flex items-center gap-3">
            ...
            <div>
                <h3 class="font-bold text-rose-800">Terlambat Dikembalikan!</h3>
                <p class="text-sm text-rose-600">Buku melewati batas waktu pengembalian. Segera lakukan pengembalian.</p>
            </div>
        </div>
        @endif
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="flex items-start gap-4 p-4 bg-slate-50 rounded-xl border border-slate-100">
                            <div class="w-16 h-20 bg-indigo-100 rounded flex-shrink-0 flex items-center justify-center text-indigo-400">
                            ...
                            <div>
                                ...
                                <a href="{{ route('books.show', $borrowing->book->id) }}" class="inline-block mt-2 text-xs font-semibold text-indigo-600 hover:text-indigo-800">
                                    Lihat Detail Buku &rarr;
                                </a>
                            </div>
                        </div>
                        @else
                        <div class="p-4 bg-rose-50 rounded-xl border border-rose-100 text-rose-600 text-sm font-medium">
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="bg-rose-50 p-6 rounded-xl border border-rose-100 flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-rose-800 mb-1">Total Denda Keterlambatan</p>
                                <p class="text-3xl font-extrabold text-rose-600">Rp{{ number_format($borrowing->fine, 0, ',', '.') }}</p>
                            </div>
                            <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm border border-rose-100">
