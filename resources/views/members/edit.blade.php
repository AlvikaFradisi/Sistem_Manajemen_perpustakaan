...
<div class="mb-6 flex items-center justify-between">
    <div>
        ...
        <p class="text-sm text-slate-500">Silakan ubah formulir di bawah ini untuk memperbarui data anggota.</p>
    </div>
...
<div class="bg-white rounded-2xl border border-sky-100 shadow-sm overflow-hidden">
    <form action="{{ route('members.update', $member->id) }}" method="POST" class="p-6 sm:p-8">
        @csrf
        @method('PUT')
