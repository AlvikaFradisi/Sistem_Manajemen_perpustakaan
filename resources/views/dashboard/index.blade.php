                ...
                <tr class="hover:bg-sky-50/30 transition-colors">
                    ...
                    <td class="px-6 py-4 text-center">
                        ...
                        @elseif($borrowing->status === 'Dipinjam')
                            <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[11px] font-bold bg-cyan-50 text-cyan-700 border border-cyan-100">
                ...
                <tr>
                    <td colspan="4" class="px-6 py-14 text-center">
                        <div class="inline-flex flex-col items-center">
                            <div class="w-14 h-14 rounded-2xl mb-3 flex items-center justify-center bg-sky-50 border border-sky-100">
                                <svg class="h-7 w-7 text-sky-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
