...
<div class="mb-6 flex items-center justify-between">
    <div class="flex items-center gap-4">
        <a href="{{ route('books.index') }}" class="p-2 bg-white text-slate-500 hover:text-indigo-600 rounded-lg border border-slate-200 shadow-sm hover:border-indigo-200 transition-colors">
    ...
    <div class="flex gap-2">
        <a href="{{ route('books.edit', $book->id) }}" class="inline-flex items-center px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-semibold text-slate-700 hover:bg-slate-50 hover:text-indigo-600 transition-colors">
...
<div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
    <div class="p-8 md:p-10 flex flex-col md:flex-row gap-10">
        ...
        <div class="w-full md:w-1/3 flex flex-col items-center">
            <div class="w-48 h-64 md:w-64 md:h-80 bg-indigo-50 border-2 border-dashed border-indigo-200 rounded-xl flex items-center justify-center text-indigo-300 shadow-inner mb-6">
        ...
        <div class="w-full md:w-2/3">
            <div class="mb-6">
                <div class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-100 mb-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8 bg-slate-50 rounded-xl p-6 border border-slate-100">
                ...
                <div>
                    ...
                    @else
                        <span class="inline-flex items-center gap-1.5 text-sm font-bold text-rose-600">
