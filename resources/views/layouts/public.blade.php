...
<head>
    ...
    <style>
        ...
        ::-webkit-scrollbar-thumb { background: #fda4af; border-radius: 9999px; border: 2px solid #fdf2f4; }
...
<body class="font-sans antialiased text-slate-800 min-h-screen flex flex-col">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <a href="{{ route('landing.index') }}" class="flex items-center gap-3 group">
                    ...
                    <div>
                        <span class="text-xl font-bold tracking-tight text-rose-950">E-Perpus</span>
                        <p class="text-xs font-medium text-rose-600/70 -mt-0.5">Katalog Publik</p>
                    </div>
                </a>

                <!-- Desktop Menu -->
                <div class="hidden md:flex items-center gap-8">
                    <a href="{{ route('landing.index') }}" class="text-sm font-semibold text-rose-900 hover:text-rose-600 transition-colors">Beranda</a>
                    <a href="#katalog" class="text-sm font-semibold text-rose-900 hover:text-rose-600 transition-colors">Katalog Buku</a>
                    
                    <div class="w-px h-6 bg-rose-200"></div>
                ...
                <div class="md:hidden flex items-center" x-data="{ mobileMenuOpen: false }">
                    <button @click="mobileMenuOpen = !mobileMenuOpen" class="text-rose-900 hover:text-rose-600 focus:outline-none p-2">
                    ...
                    <div x-show="mobileMenuOpen" @click.away="mobileMenuOpen = false" 
                         class="absolute top-20 right-4 w-48 bg-white rounded-xl shadow-2xl border border-rose-100 py-2 flex flex-col"
                         ...
                         style="display: none;">
                        <a href="{{ route('landing.index') }}" class="px-4 py-2 text-sm font-semibold text-rose-900 hover:bg-rose-50">Beranda</a>
                        <a href="#katalog" class="px-4 py-2 text-sm font-semibold text-rose-900 hover:bg-rose-50">Katalog Buku</a>
                        <div class="border-t border-rose-50 my-1"></div>
                        <a href="{{ route('dashboard') }}" class="px-4 py-2 text-sm font-bold text-rose-600 hover:bg-rose-50 flex items-center justify-between">
                            Login Admin
    ...
    <!-- ===== FOOTER ===== -->
    <footer class="bg-white border-t border-rose-100 py-8 mt-auto relative z-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div class="flex items-center gap-2">
                <div class="w-6 h-6 rounded-md flex items-center justify-center bg-rose-100 text-rose-600">
